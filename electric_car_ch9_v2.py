...
# Example: breaking out attributes for battery into a separate class.
class Battery:
...
# To use this method, tell Python to find the battery attribute, then
# use the method associated with the Battery() instance stored in the
# attribute.
